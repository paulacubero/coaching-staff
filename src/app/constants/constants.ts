...
export const SQUAD_LIST_COLUMNS = [
  { header: 'Dorsal', dataKey: 'dorsal' },
  { header: 'Nombre', dataKey: 'name' },
  { header: 'Apellido', dataKey: 'surname' },
  { header: 'Firma', dataKey: '' },
]
...
export const PLAYERS: Player[] = [
  {
    ...
    available: true,
    dorsal: 10,
    img: 'https://primefaces.org/cdn/primeng/images/demo/avatar/ivanmagalhaes.png',
  },
  {
    id: '2',
    name: 'Ludmila',
